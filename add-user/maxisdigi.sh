...
patchtls=/hacker-vmesswstls
patchnontls=/hacker-vmesswsntls
...
patchtls=/hacker-vlesswstls
patchnontls=/hacker-vlesswsntls
uuid=$(cat /proc/sys/kernel/random/uuid)
read -p "   Bug Address (Example: www.google.com) : " address
read -p "   Bug SNI/Host (Example : m.facebook.com) : " sni
read -p "   Expired (days) : " masaaktif
...
patchtls=/hacker-trojanwstls
patchnone=/hacker-trojanwsntls
read -p "   Bug Address (Example: www.google.com) : " address
